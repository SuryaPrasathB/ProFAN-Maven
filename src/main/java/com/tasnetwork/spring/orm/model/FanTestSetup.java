...
public class FanTestSetup {
	...
	public void setVibrationLowerLimit(String vibrationLowerLimit) {
		...
		this.vibrationLowerLimitProperty.set(vibrationLowerLimit); // <--- ADDED: Update property
	}

	public SimpleStringProperty getVibrationLowerLimitProperty() {
		vibrationLowerLimitProperty.set(vibrationLowerLimit);
	...
	public void setVibrationUpperLimit(String vibrationUpperLimit) {
		...
		this.vibrationUpperLimitProperty.set(vibrationUpperLimit); // <--- ADDED: Update property
	}

	public SimpleStringProperty getVibrationUpperLimitProperty() {
		vibrationUpperLimitProperty.set(vibrationUpperLimit);
	...
	public void setVibrationActual(String vibrationActual) {
		...
		this.vibrationActualProperty.set(vibrationActual); // Corrected property update method
	}

	public SimpleStringProperty vibrationActualProperty() {
		return vibrationActualProperty;
	}

	public void setVibrationActualPropertgetVibrationUpperLimitPropertyy(SimpleStringProperty vibrationActualProperty) {
	...
	public void setRpmLowerLimit(String rpmLowerLimit) {
		...
		this.rpmLowerLimitProperty.set(rpmLowerLimit); // <--- ADDED: Update property
	}
	...
	public void setRpmUpperLimit(String rpmUpperLimit) {
		...
		this.rpmUpperLimitProperty.set(rpmUpperLimit); // <--- ADDED: Update property
	}
	...
	public void setWindSpeedLowerLimit(String windSpeedLowerLimit) {
		...
		this.windSpeedLowerLimitProperty.set(windSpeedLowerLimit); // <--- ADDED: Update property
	}
	...
	public void setWindSpeedUpperLimit(String windSpeedUpperLimit) {
		...
		this.windSpeedUpperLimitProperty.set(windSpeedUpperLimit); // <--- ADDED: Update property
	}
	...
	public void setCurrentLowerLimit(String currentLowerLimit) {
		...
		this.currentLowerLimitProperty.set(currentLowerLimit); // <--- ADDED: Update property
	}
	...
	public void setCurrentUpperLimit(String currentUpperLimit) {
		...
		this.currentUpperLimitProperty.set(currentUpperLimit); // <--- ADDED: Update property
	}
	...
	public void setWattsLowerLimit(String wattsLowerLimit) {
		...
		this.wattsLowerLimitProperty.set(wattsLowerLimit); // <--- ADDED: Update property
	}
	...
	public void setWattsUpperLimit(String wattsUpperLimit) {
		...
		this.wattsUpperLimitProperty.set(wattsUpperLimit); // <--- ADDED: Update property
	}
	...
	public void setActivePowerLowerLimit(String activePowerLowerLimit) {
		...
		this.activePowerLowerLimitProperty.set(activePowerLowerLimit); // <--- ADDED: Update property
	}
	...
	public void setActivePowerUpperLimit(String activePowerUpperLimit) {
		...
		this.activePowerUpperLimitProperty.set(activePowerUpperLimit); // <--- ADDED: Update property
	}
	...
	public void setPowerFactorLowerLimit(String powerFactorLowerLimit) {
		...
		this.powerFactorLowerLimitProperty.set(powerFactorLowerLimit); // <--- ADDED: Update property
	}
	...
	public void setPowerFactorUpperLimit(String powerFactorUpperLimit) {
		...
		this.powerFactorUpperLimitProperty.set(powerFactorUpperLimit); // <--- ADDED: Update property
	}
	...
	public SimpleBooleanProperty vibValidProperty() {
		return vibrationValid;
	}
	...
	public String toString() {
		return "FanTestSetup{" +
				...
				", setupTimeInSec=" + setupTimeInSec +
				", rpmLowerLimit='" + rpmLowerLimit + '\'' +
				", rpmUpperLimit='" + rpmUpperLimit + '\'' +
				", rpmActual='" + rpmActual + '\'' +
				", windSpeedLowerLimit='" + windSpeedLowerLimit + '\'' +
				", windSpeedUpperLimit='" + windSpeedUpperLimit + '\'' +
				", windSpeedActual='" + windSpeedActual + '\'' +
				", vibrationLowerLimit='" + vibrationLowerLimit + '\'' +
				", vibrationUpperLimit='" + vibrationUpperLimit + '\'' +
				", vibrationActual='" + vibrationActual + '\'' +
				", currentLowerLimit='" + currentLowerLimit + '\'' +
				", currentUpperLimit='" + currentUpperLimit + '\'' +
				", currentActual='" + currentActual + '\'' +
				", wattsLowerLimit='" + wattsLowerLimit + '\'' +
				", wattsUpperLimit='" + wattsUpperLimit + '\'' +
				", wattsActual='" + wattsActual + '\'' +
				", activePowerLowerLimit='" + activePowerLowerLimit + '\'' +
				", activePowerUpperLimit='" + activePowerUpperLimit + '\'' +
				", activePowerActual='" + activePowerActual + '\'' +
				", powerFactorLowerLimit='" + powerFactorLowerLimit + '\'' +
				", powerFactorUpperLimit='" + powerFactorUpperLimit + '\'' +
				", powerFactorActual='" + powerFactorActual + '\'' +
				", serialNo=" + serialNo +
				", active=" + active +
