...
public class EditCellDeploymentManage <S, T> extends TextFieldTableCell<S, T> {
	...
	public EditCellDeploymentManage(final StringConverter<T> converter) {
		super(converter);
	}
	...
	public static <S, T> Callback<TableColumn<S, T>, TableCell<S, T>> forTableColumn(
		...
		return list -> new EditCellDeploymentManage<S, T>(converter);
	}
	...
	private TextField getTextField() {
		...
		textField.addEventFilter(KeyEvent.KEY_PRESSED, event -> {
			if (event.getCode() == KeyCode.ESCAPE) {
				...
				ApplicationLauncher.logger.debug("EditCellDeploymentManage: getTextField: Tab");
				DeploymentManagerController.editFocusedCellOnTableViewDeploymentManage();
...
/*	@SuppressWarnings("unchecked")
	...
	public static void setPresentActiveTable(TableView<?> presentActiveTable) {
		EditCellDeploymentManage.presentActiveTable = presentActiveTable;
	}
}
