...
public class RepeatabilityReportCellPosition {
	...
	@SerializedName("testDurationCell")
	@Expose
	private String testDurationCell;
	@SerializedName("testIntervalCell")
	@Expose
	private String testIntervalCell;
	...
	public String getTestDurationCell() {
		return testDurationCell;
	}

	public void setTestDurationCell(String testDurationCell) {
		this.testDurationCell = testDurationCell;
	}

	public String getTestIntervalCell() {
		return testIntervalCell;
	}

	public void setTestIntervalCell(String testIntervalCell) {
		this.testIntervalCell = testIntervalCell;
	}
