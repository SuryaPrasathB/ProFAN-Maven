...
public class HarmonicsSelectOrder_B_Phase_I_CheckBoxValueFactory  implements Callback<TableColumn.CellDataFeatures<HarmonicsDataModel, CheckBox>, ObservableValue<CheckBox>> {
	...
	public ObservableValue<CheckBox> call(CellDataFeatures<HarmonicsDataModel, CheckBox> param) {
		...
		checkBox.selectedProperty().addListener((ov, old_val, new_val) -> {
			rowData.setHarmonicOrder_I_Selected(new_val);
			if(new_val){
