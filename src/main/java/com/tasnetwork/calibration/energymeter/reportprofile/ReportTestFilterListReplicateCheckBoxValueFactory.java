...
public class ReportTestFilterListReplicateCheckBoxValueFactory implements Callback<TableColumn.CellDataFeatures<ReportProfileTestDataFilter, CheckBox>, ObservableValue<CheckBox>> {
	...
	public ObservableValue<CheckBox> call(CellDataFeatures<ReportProfileTestDataFilter, CheckBox> param) {
		...
		// setGraphic(checkBox);
		checkBox.selectedProperty().setValue(rowData.isReplicateData());
		checkBox.selectedProperty().addListener((ov, old_val, new_val) -> {
			rowData.setReplicateData(new_val);
		});
